...
from lolapy.assistant.pml.prompt_compiler import PromptCompiled, PromptCompiler
...
os.environ["LANGCHAIN_API_KEY"] = "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"
...
if __name__ == "__main__":
    ...
    # LilaAgent
    agent = LilaAgent( api_key=OPENAI_API_KEY, 
                        redis=redis,
